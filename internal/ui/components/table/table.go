...
// This is a local fork of github.com/charmbracelet/bubbles/table with
// ANSI-aware string truncation (using x/ansi instead of go-runewidth)
// to fix column misalignment when cell values contain ANSI escape codes.
package table
